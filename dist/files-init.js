...
class FilenameFilter extends _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.FileListFilter {
  ...
  updateQuery(query) {
    ...
    if (query !== this.searchQuery) {
      ...
      this.dispatchTypedEvent('update:query', new CustomEvent('update:query', {
        detail: query
      }));
    }
  }
...
/* harmony import */ var _components_FileListFilter_FileListFilterModified_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/FileListFilter/FileListFilterModified.vue */ "./apps/files/src/components/FileListFilter/FileListFilterModified.vue");
/* harmony import */ var _mdi_svg_svg_calendar_svg_raw__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mdi/svg/svg/calendar.svg?raw */ "./node_modules/@mdi/svg/svg/calendar.svg?raw");
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
class ModifiedFilter extends _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileListFilter {
  ...
  mount(el) {
    ...
    const View = vue__WEBPACK_IMPORTED_MODULE_4__["default"].extend(_components_FileListFilter_FileListFilterModified_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  setPreset(preset) {
    ...
    if (preset) {
      chips.push({
        icon: _mdi_svg_svg_calendar_svg_raw__WEBPACK_IMPORTED_MODULE_3__,
        text: preset.label,
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _views_search__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../views/search */ "./apps/files/src/views/search.ts");
...
const useSearchStore = (0,pinia__WEBPACK_IMPORTED_MODULE_3__.defineStore)('search', () => {
  /**
   * The current search query
   */
  const query = (0,vue__WEBPACK_IMPORTED_MODULE_4__.ref)('');
  /**
   * Where to start the search
   */
  const base = (0,vue__WEBPACK_IMPORTED_MODULE_4__.ref)();
  /**
   * Scope of the search.
   * Scopes:
   ...
   */
  const scope = (0,vue__WEBPACK_IMPORTED_MODULE_4__.ref)('filter');
  // reset the base if query is cleared
  (0,vue__WEBPACK_IMPORTED_MODULE_4__.watch)(scope, () => {
    if (scope.value !== 'locally') {
      base.value = undefined;
    }
    updateSearch();
  });
  (0,vue__WEBPACK_IMPORTED_MODULE_4__.watch)(query, (old, current) => {
   ...
   * @private
   */
  const updateRouter = debounce__WEBPACK_IMPORTED_MODULE_5___default()((isSearch, fileid) => {
    const router = window.OCP.Files.Router;
    router.goToRoute(undefined, {
      view: _views_search__WEBPACK_IMPORTED_MODULE_1__.VIEW_ID,
      ...(fileid === undefined ? {} : {
        fileid: String(fileid)
      })
    }, {
  ...
  function updateSearch() {
    ...
    if (router.params.view === _views_search__WEBPACK_IMPORTED_MODULE_1__.VIEW_ID && (query.value === '' || scope.value === 'filter')) {
      scope.value = 'filter';
    ...
    const isSearch = router.params.view === _views_search__WEBPACK_IMPORTED_MODULE_1__.VIEW_ID;
    _logger__WEBPACK_IMPORTED_MODULE_2__["default"].debug('Update route for updated search query', {
      query: query.value,
      fileid,
      isSearch
    });
  ...
  function onViewChanged(view) {
    if (view.id !== _views_search__WEBPACK_IMPORTED_MODULE_1__.VIEW_ID) {
      query.value = '';
      scope.value = 'filter';
    }
  }
  ...
  function initialize() {
    ...
    if (router.params.view === _views_search__WEBPACK_IMPORTED_MODULE_1__.VIEW_ID) {
      query.value = [router.query.query].flat()[0] ?? '';
      if (query.value) {
        scope.value = 'globally';
        _logger__WEBPACK_IMPORTED_MODULE_2__["default"].debug('Directly navigated to search view', {
          query: query.value
        });
      } else {
        // we do not have any query so we need to move to the files list
        _logger__WEBPACK_IMPORTED_MODULE_2__["default"].info('Directly navigated to search view without any query, redirect to files view.');
        router.goToRoute(undefined, {
          ...router.params,
          view: 'files'
        }, {
...
const useUserConfigStore = (0,pinia__WEBPACK_IMPORTED_MODULE_5__.defineStore)('userconfig', () => {
  ...
  async function update(key, value) {
    ...
    if ((0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)() !== null) {
      await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_4__["default"].put((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateUrl)('/apps/files/api/v1/config/{key}', {
        key
      }), {
        value
      });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  ...
  const storageStats = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_4__.loadState)('files', 'storageStats', {
    quota: -1
  });
...
/* harmony import */ var _nextcloud_paths__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nextcloud/paths */ "./node_modules/@nextcloud/paths/dist/index.mjs");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _nextcloud_vue_components_NcUserBubble__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nextcloud/vue/components/NcUserBubble */ "./node_modules/@nextcloud/vue/dist/Components/NcUserBubble.mjs");
/**
 * SPDX-FileCopyrightText: 2024 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
const deletedBy = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.Column({
  ...
  render(node) {
    ...
    const UserBubble = vue__WEBPACK_IMPORTED_MODULE_5__["default"].extend(_nextcloud_vue_components_NcUserBubble__WEBPACK_IMPORTED_MODULE_4__["default"]);
    const propsData = {
      size: 32,
...
/***/ "./node_modules/@mdi/svg/svg/magnify.svg?raw":
/*!***************************************************!*\
  !*** ./node_modules/@mdi/svg/svg/magnify.svg?raw ***!
  \***************************************************/
/***/ ((module) => {

module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"mdi-magnify\" viewBox=\"0 0 24 24\"><path d=\"M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z\" /></svg>";
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-BC-7VPxC_mjs":"0a21f85fb5edb886fad0","node_modules_nextcloud_dialogs_dist_chunks_PublicAuthPrompt-BSFsDqYB_mjs":"5414d4143400c9b713c3","apps_files_src_views_SearchEmptyView_vue":"6f2dcaf4555682322ec6","node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-BYpqWa7P_mjs":"377aaecad1616d034505","node_modules_nextcloud_upload_dist_chunks_ConflictPicker-BvM7ZujP_mjs":"8bb43b6fcd510001c73d","apps_files_src_views_TemplatePicker_vue":"1ce523e47fa250f92a06","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-391a6e":"87f84948225387ac2eec"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files-init.js.map?v=e67d5ef5595b56f74973