...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_EncryptionSettings_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EncryptionSettings.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/Encryption/EncryptionSettings.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_EncryptionSettings_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_EncryptionWarningDialog_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EncryptionWarningDialog.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/Encryption/EncryptionWarningDialog.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_EncryptionWarningDialog_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
const textExistingFilesNotEncrypted = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.t)('settings', 'For performance reasons, when you enable encryption on a Nextcloud server only new and changed files are encrypted.');
...
/* harmony import */ var _components_AdminTwoFactor_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/AdminTwoFactor.vue */ "./apps/settings/src/components/AdminTwoFactor.vue");
/* harmony import */ var _components_Encryption_EncryptionSettings_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/Encryption/EncryptionSettings.vue */ "./apps/settings/src/components/Encryption/EncryptionSettings.vue");
/* harmony import */ var _store_admin_security_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./store/admin-security.js */ "./apps/settings/src/store/admin-security.js");
/**
...
_store_admin_security_js__WEBPACK_IMPORTED_MODULE_4__["default"].replaceState((0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'mandatory2FAState'));
const View = vue__WEBPACK_IMPORTED_MODULE_5__["default"].extend(_components_AdminTwoFactor_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
new View({
  store: _store_admin_security_js__WEBPACK_IMPORTED_MODULE_4__["default"]
}).$mount('#two-factor-auth-settings');
const EncryptionView = vue__WEBPACK_IMPORTED_MODULE_5__["default"].extend(_components_Encryption_EncryptionSettings_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/Encryption/EncryptionSettings.vue?vue&type=script&setup=true&lang=ts":
/*!*************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/Encryption/EncryptionSettings.vue?vue&type=script&setup=true&lang=ts ***!
  \*************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sharedTexts.ts */ "./apps/settings/src/components/Encryption/sharedTexts.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_12__.defineComponent)({
  ...
  setup(__props) {
    const allEncryptionModules = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'encryption-modules');
    /** Available encryption modules on the backend */
    const encryptionModules = Array.isArray(allEncryptionModules) ? [] : Object.entries(allEncryptionModules).map(_ref => {
      let [id, module] = _ref;
      return {
        ...module,
        id
    ...
    const encryptionReady = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'encryption-ready');
    /** Are external backends enabled (legacy ownCloud stuff) */
    const externalBackendsEnabled = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'external-backends-enabled');
    /** URL to the admin docs */
    const encryptionAdminDoc = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'encryption-admin-doc');
    /** Is the encryption enabled */
    const encryptionEnabled = (0,vue__WEBPACK_IMPORTED_MODULE_12__.ref)((0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'encryption-enabled'));
    /** Loading state while enabling encryption (e.g. because the confirmation dialog is open) */
    const loadingEncryptionState = (0,vue__WEBPACK_IMPORTED_MODULE_12__.ref)(false);
    /**
    ...
    function displayWarning(enabled) {
      ...
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.spawnDialog)(_EncryptionWarningDialog_vue__WEBPACK_IMPORTED_MODULE_11__["default"], {}, async confirmed => {
        try {
          if (confirmed) {
    ...
    async function update(key, value) {
      ...
      const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_4__.generateOcsUrl)('/apps/provisioning_api/api/v1/config/apps/{appId}/{key}', {
        appId: 'core',
        key
      });
      try {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('settings', 'Unable to update server side encryption config'));
        _logger_ts__WEBPACK_IMPORTED_MODULE_7__["default"].error('Unable to update server side encryption config', {
          error
        });
        return false;
      }
    ...
    return {
      ...
      textExistingFilesNotEncrypted: _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_5__.textExistingFilesNotEncrypted,
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/Encryption/EncryptionWarningDialog.vue?vue&type=script&setup=true&lang=ts":
/*!******************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/Encryption/EncryptionWarningDialog.vue?vue&type=script&setup=true&lang=ts ***!
  \******************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/l10n */ "./node_modules/@nextcloud/l10n/dist/index.mjs");
/* harmony import */ var _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sharedTexts.ts */ "./apps/settings/src/components/Encryption/sharedTexts.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_4__.defineComponent)({
  ...
  setup(__props, _ref) {
    ...
    const buttons = [{
      label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.t)('settings', 'Cancel encryption'),
      ...
      label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.t)('settings', 'Enable encryption'),
      type: 'error',
    ...
    return {
      ...
      textExistingFilesNotEncrypted: _sharedTexts_ts__WEBPACK_IMPORTED_MODULE_1__.textExistingFilesNotEncrypted,
...
/* harmony import */ var _nextcloud_vue_components_NcSelect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/vue/components/NcSelect */ "./node_modules/@nextcloud/vue/dist/Components/NcSelect.mjs");
...
/* harmony import */ var lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash/sortedUniq.js */ "./node_modules/lodash/sortedUniq.js");
/* harmony import */ var lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var lodash_uniq_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash/uniq.js */ "./node_modules/lodash/uniq.js");
/* harmony import */ var lodash_uniq_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(lodash_uniq_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var lodash_debounce_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! lodash/debounce.js */ "./node_modules/lodash/debounce.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'AdminTwoFactor',
  components: {
    NcSelect: _nextcloud_vue_components_NcSelect__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  mounted() {
    ...
    this.groups = lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_6___default()(lodash_uniq_js__WEBPACK_IMPORTED_MODULE_7___default()(this.enforcedGroups.concat(this.excludedGroups)));
  ...
  methods: {
    searchGroup: lodash_debounce_js__WEBPACK_IMPORTED_MODULE_8___default()(function (query) {
      this.loadingGroups = true;
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_9__.generateOcsUrl)('cloud/groups?offset=0&search={query}&limit=20', {
        query
      })).then(res => res.data.ocs).then(ocs => ocs.data.groups).then(groups => {
        this.groups = lodash_sortedUniq_js__WEBPACK_IMPORTED_MODULE_6___default()(lodash_uniq_js__WEBPACK_IMPORTED_MODULE_7___default()(this.groups.concat(groups)));
    ...
    saveChanges() {
      ...
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].put((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_9__.generateUrl)('/settings/api/admin/twofactorauth'), data).then(resp => resp.data).then(state => {
        this.state = state;
        this.dirty = false;
      }).catch(err => {
...
var render = function render() {
  ...
  return _c(_setup.NcSettingsSection, {
    ...
    attrs: {
      checked: _setup.encryptionEnabled,
    ...
    on: {
      "update:checked": _setup.displayWarning
    }
    ...
    return _c(_setup.NcCheckboxRadioSwitch, {
      key: module.id,
      attrs: {
        checked: _setup.defaultCheckedModule,
        value: module.id,
        type: "radio",
      ...
      on: {
        "update:checked": [function ($event) {
          _setup.defaultCheckedModule = $event;
        }, _setup.checkDefaultModule]
      }
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-security.js.map?v=390cf11fb3652968d757